...
type ResultItem = {
  ...
  _highlightResult: {
    hierarchy: Record<
      string,
      { value: string; matchLevel: string; matchedWords: string[]; fullyHighlighted: boolean }
    >;
  };
};
type AutoCompleteApiType = AutocompleteApi<
  ResultItem,
  React.ChangeEvent<HTMLInputElement>,
  React.MouseEvent<HTMLElement, MouseEvent>,
  React.KeyboardEvent<HTMLInputElement>
>;
type AutocompleteStateType = AutocompleteState<ResultItem>;

function useAutocomplete() {
  let id = useId();
  let router = useRouter();
  let [autocompleteState, setAutocompleteState] = useState<AutocompleteStateType>(
    {} as AutocompleteStateType
  );
                ...
                queries: [
                  {
                    ...
                    params: {
                      hitsPerPage: 5,
                      highlightPreTag: '<mark class="underline bg-transparent text-secondary-600">',
...
function resolveResult(result: ResultItem) {
  console.log(result);
...
function SearchResult({
  ...
  result: ResultItem;
  resultIndex: number;
  autocomplete: AutoCompleteApiType;
  collection: AutocompleteCollection<ResultItem>;
}) {
  let id = useId();
...
function SearchResults({
  ...
  return (
    <ul {...autocomplete.getListProps()} role="list">
...
const SearchInput = forwardRef<
  HTMLInputElement,
  ReturnType<typeof useAutocomplete> & { onClose(): void }
...
function AlgoliaLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
            ...
            <Dialog.Panel className="mx-auto overflow-hidden rounded-lg bg-zinc-50 shadow-xl ring-1 ring-zinc-900/7.5 dark:bg-zinc-900 dark:ring-zinc-800 sm:max-w-xl">
              <div {...autocomplete.getRootProps({})}>
                ...
                >
                  ...
                  <div
                    ref={panelRef}
                    className="border-t border-zinc-200 bg-white empty:hidden dark:border-zinc-100/5 dark:bg-white/5"
