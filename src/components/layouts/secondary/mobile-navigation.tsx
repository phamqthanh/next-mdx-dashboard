...
export function MobileNavigation({ navigation }: { navigation?: NavigationGroupType[] }) {
          ...
          <Dialog onClose={close} className="fixed inset-0 z-50 lg:hidden">
            ...
            <Dialog.Panel>
              ...
              >
                <motion.div
                  layoutScroll
                  className="fixed left-0 top-14 bottom-0 w-full overflow-y-auto bg-white px-4 pt-6 pb-4 shadow-lg shadow-zinc-900/10 dark:bg-secondary-900 min-[416px]:max-w-sm sm:px-6 sm:pb-10"
                >
