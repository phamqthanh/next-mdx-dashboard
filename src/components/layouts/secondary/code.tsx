...
function CodePanelHeader({ tag, label }: any) {
  if (!tag && !label) {
    return null;
  }

  return (
    <div className="flex h-9 items-center gap-2 border-y border-t-transparent border-b-white/20 bg-zinc-900 bg-white/5 px-4 dark:border-b-white/5 dark:bg-white/5">
      {tag && (
...
function CodePanel({ tag, label, code, children }: any) {
...
function CodeGroupHeader({ title, children, selectedIndex }: any) {
